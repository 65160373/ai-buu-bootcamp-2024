...
async def lifespan(app: FastAPI):
    ...
    sample_documents = [
        "ชนิกานต์ ประถมทอง คือ เด็กสาวที่เรียนอยู่มหาวิทยาลัยบรูพา คณะวิทยาการสารสนเทศ สาขาเทคโนโลยีสารสนเทศอุตสาหกรรมดิจิทัล มหาวิทยาลัยบรูพา",
        "ชนิกานต์ ประถมทอง มีชื่อเล่นว่า วุ้นเส้น เกิดวันที่ 7 สิงหาคม 2546",
        "งาน BUU-Bootcamp-2024 จัดที่มหาวิทยาลัยบูรพา ในวันที่ 12 ธันวาคม ปี ค.ศ.2024 โดยมีการจัดกิจกรรมต่าง ๆ ที่เกี่ยวข้องกับการพัฒนาซอฟต์แวร์ เวลา 8:30 น. - 16:30 น.",
        "ผู้เข้าร่วม 171 คน",
        "ทีม AI พี่เจ๋ง dev พี่ปาล์ม dev พี่ดาว ba พี่ออย ba พี่ซวน data"
    ]
